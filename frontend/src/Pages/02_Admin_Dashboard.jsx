...
const App = () => {
  ...
  useEffect(() => {
    const data = async () => {
      ...
      const userobj = {
        ...
        Expired_Membership: res.data.Expired_Membership,
        Total_Members: res.data.Total_Members,
        Total_Payments: res.data.Total_Payments,
        Upcoming_Renewals: res.data.Upcoming_Renewals,
      };
      setUserData(userobj)
    };
    data();
  ...
  const stats = [
    ...
    },
    {
      ...
      value: userData.Upcoming_Renewals,
      icon: Calendar,
      color: "bg-red-500",
    },
    {
      ...
      value: userData.Expired_Membership,
      icon: Calendar,
      color: "bg-red-500",
    },
  ];
        ...
        {/* <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 h-64">
            ...
            <p className="text-gray-600">
              Data for member growth will appear here.
            </p>
          </div>
        </section> */}
      </main>
